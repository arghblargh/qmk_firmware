...
[0] = LAYOUT_multi( \
        ...
        KC_LCTL,    KC_LGUI,    KC_LALT,                            KC_SPC,     MO(2),      KC_BSPC,                MO(1),      KC_RCTL,    KC_NO,                  KC_LEFT,    KC_DOWN,    KC_RGHT     \
    ),
[1] = LAYOUT_multi( \
        ...
        KC_TRNS,    KC_TRNS,    KC_TRNS,                            KC_TRNS,    KC_TRNS,    KC_TRNS,                KC_TRNS,    KC_TRNS,    KC_NO,                  KC_MPRV,    KC_VOLD,    KC_MNXT     \
    ),
[2] = LAYOUT_multi( \
        KC_GRV,     KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,     KC_TRNS,    KC_TRNS,    KC_TRNS,    \
        KC_TRNS,                KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_P7,      KC_P8,      KC_P9,      KC_NLCK,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    \
        KC_TRNS,                KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_P4,      KC_P5,      KC_P6,      KC_TRNS,    KC_TRNS,    KC_TRNS,                KC_TRNS,    \
        KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_P1,      KC_P2,      KC_P3,      KC_PDOT,    KC_TRNS,                KC_TRNS,    KC_TRNS,    \
        KC_TRNS,    KC_TRNS,    KC_TRNS,                            KC_TRNS,    KC_TRNS,    KC_P0,                  KC_TRNS,    KC_TRNS,    KC_NO,                  KC_TRNS,    KC_TRNS,    KC_TRNS     \
    ),
};
